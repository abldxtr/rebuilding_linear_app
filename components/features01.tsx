export const Features01 = () => {
  //     const items = [
  // {
  //     header : "Document decoder",
  //     sub : "Transform complex content into understandable format",
  //     icone: <svg
        ...
        <div className="relative mx-auto max-w-7xl px-4 lg:px-16">
          ...
          <div className="mt-8 lg:mt-16">
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 lg:gap-y-16">
              ...
              <div
                // style="--delay:600ms;"
                className="transition-all delay-[--delay] [--delay:600ms] duration-[--duration]"
              >
                <div className="flex items-center">
                  <div className="rounded border border-white/5 bg-white/5 p-1">
                    <svg
              ...
              <div
                // style="--delay:750ms;"
                className="transition-all delay-[--delay] [--delay:750ms] duration-[--duration]"
              >
                <div className="flex items-center">
                  <div className="rounded border border-white/5 bg-white/5 p-1">
                    <svg
